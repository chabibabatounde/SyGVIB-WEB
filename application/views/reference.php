...
<head>
    ...
    <!-- Animation Css -->
    <link href="<?php echo assets('plugins/animate-css/animate.css.css'); ?>" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?php echo assets('css/style.css" rel="stylesheet.css'); ?>">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo assets('css/themes/all-themes.css" rel="stylesheet.css'); ?>" />
</head>
