...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>VISITES TECHNIQUES POUR <?php echo $voiture['immatriculation']; ?></h2>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Saisissez les données de la visite
                        </h2>
                    </div>
                    <!--div class="body row">
                        <div class="demo-checkbox">
                            <input type="checkbox" id="basic_checkbox_2" class="filled-in" checked />
                            <label for="basic_checkbox_2">Freinage</label>
                            <input type="checkbox" id="basic_checkbox_2" class="filled-in" checked />
                            <label for="basic_checkbox_2">Eclairage</label>
                            <input type="checkbox" id="basic_checkbox_2" class="filled-in" checked />
                            <label for="basic_checkbox_2">Vitrage</label>
                            <input type="checkbox" id="basic_checkbox_2" class="filled-in" checked />
                            <label for="basic_checkbox_2">Pneu</label>
                        </div>
                    </div-->
                    <form action="<?php echo lien('CNSR','addVisite'); ?>" method="POST">
                        <div class="body row">
                            <div class="col-lg-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input value="<?php echo($voiture['idVoiture']); ?>" type="hidden" name="idVoiture">
                                        <input name ="verdict" type="text" class="form-control" placeholder="Virdict de la visite" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <button class="btn btn-block bg-green waves-effect" type="submit">Valider la visite</button>
                            </div>
                        </div>
                    </form>
                </div>
